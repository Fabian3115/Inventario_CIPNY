        ...
        <div class="col-12 col-lg-8">
            <div class="card shadow-sm">
                <div class="card-header border-0"
                    style="background:linear-gradient(90deg, var(--ny-blue-700,#0b4d6d), var(--ny-blue-500,#1c8fb6));">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="codeInput" type="number" min="1" name="code"
                                        ...
                                        placeholder="Ej: 1001" required data-check-url="{{ route('products.checkCode') }}">
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="description"
                                        ...
                                        value="{{ old('description') }}" placeholder="Nombre o detalle del producto"
                                        required>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input list="categories_suggestions" type="text" name="categories"
                                        ...
                                        value="{{ old('categories') }}" placeholder="Ej: Redes, Cómputo..." required>
                                    @error('categories')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="input-group">
                                ...
                                <select id="warehouse" name="warehouse"
                                    ...
                                    <option value="" disabled {{ old('warehouse') ? '' : 'selected' }}>Seleccione…
                                    </option>
                                    <option value="Servidor" {{ old('warehouse') == 'Servidor' ? 'selected' : '' }}>
                                        Servidor</option>
                                    <option value="Piso 3" {{ old('warehouse') == 'Piso 3' ? 'selected' : '' }}>Piso 3
                                    </option>
                                </select>
                                @error('warehouse')
                                    <div class="invalid-feedback">{{ $message }}</div>
