...
@section('content')
    ...
    <div class="row g-3">
        <div class="col-12 col-lg-8">
            <div class="card shadow-sm">
                <div class="card-header border-0" style="background:linear-gradient(90deg,#b72020,#e74c3c);">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('movements.out.store') }}" novalidate id="outForm">
                        ...
                        <div class="row g-3">
                                    ...
                                    <select id="productSelect" name="product_id"
                                        ...
                                        @foreach ($products as $p)
                                            <option value="{{ $p->id }}" data-stock="{{ $p->stock }}"
                                                data-extent="{{ $p->extent }}" data-warehouse="{{ $p->warehouse }}"
                            ...
                            {{-- Fila: Entregado a + Área (lado a lado, sin bajar) --}}
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="delivered_to"
                                        ...
                                        value='{{ old('delivered_to') }}' placeholder="Persona que recibe" required>
                                    @error('delivered_to')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="areaSelect" name="area"
                                        ...
                                        <option value="" disabled {{ old('area') ? '' : 'selected' }}>Seleccione…
                                        </option>
                                        ...
                                        <option value="Mantenimiento" data-icon="bi-wrench"
                                            {{ old('area') === 'Mantenimiento' ? 'selected' : '' }}>Mantenimiento</option>
        ...
        <div class="col-12 col-lg-4">
            <div class="card shadow-sm h-100">
                <div class="card-header border-0"
                    style="background:linear-gradient(90deg, var(--ny-teal-400,#36c2b6), #7fe0d6);">
                    <div class="d-flex align-items-center gap-2 text-white">
    ...
    {{-- Script UX: unidad/stock/almacén y "quedará" con validación visual --}}
    <script>
        (() => {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            new TomSelect('#areaSelect', {
                ...
                shouldLoad: () => false, // no ajax
                render: {
                    option: function(data, escape) {
                        // data.icon proviene de data-icon del <option>
